...
# NOTE: You might want to remove this if tailspin is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if tailspin has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert tailspin executable exists.
		local tool_cmd
